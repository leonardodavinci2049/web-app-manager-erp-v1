...
export const TAXONOMY_BASE_ENDPOINTS = {
  ...
  PRODUCT_MANAGER: "/taxonomy-base/v3/taxonomy-product-manager",
  FIND_MENU_MANAGER: "/taxonomy-base/v3/taxonomy-find-menu-manager",
...
export const BRAND_ENDPOINTS = {
  ...
  FIND_MANAGER_ID: "/brand/v2/brand-find-manager-id",
