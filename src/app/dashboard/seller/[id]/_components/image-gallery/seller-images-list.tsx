...
import { updateSellerImagePathFromPrimaryAction } from "../../_actions/seller-image-gallery-actions";
...
export function SellerImagesList({
  ...
  const updateImagePath = () => {
    startUpdateTransition(async () => {
      const result = await updateSellerImagePathFromPrimaryAction(sellerId);
      if (!result.success) {
