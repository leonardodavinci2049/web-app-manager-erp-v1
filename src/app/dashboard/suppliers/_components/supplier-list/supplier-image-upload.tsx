...
import { uploadSupplierListingImageAction } from "../../_actions/supplier-listing-image-actions";
...
/**
 * Gatilho de upload de imagem do fornecedor na listagem (Client). Aceita
...
export function SupplierImageUpload({
  ...
  const inputId = `supplier-image-file-${viewMode}-${supplierId}${compact ? "-compact" : ""}`;
  ...
  const handleImageUpload = useCallback(
    async (files: FileList | null) => {
      ...
      try {
        ...
        const result = await uploadSupplierListingImageAction(formData);
  ...
  return (
    <button
      type="button"
      aria-label="Enviar imagem do fornecedor"
