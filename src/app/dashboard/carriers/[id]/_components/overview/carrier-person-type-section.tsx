...
import type { CarrierPersonTypeId } from "../carrier-detail-utils";
...
interface CarrierPersonTypeSectionProps {
  currentPersonTypeId?: CarrierPersonTypeId;
  selectedPersonTypeId?: CarrierPersonTypeId;
  onSelect: (personTypeId: CarrierPersonTypeId) => void;
}

export function CarrierPersonTypeSection({
  currentPersonTypeId,
  selectedPersonTypeId,
  onSelect,
}: CarrierPersonTypeSectionProps) {
  return (
